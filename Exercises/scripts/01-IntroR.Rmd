...
This workshop is beginner-level introduction to programming in R. The course is designed to be taught in two sessions of 2 hours each and is focused on the application of R to the analysis of tabular data from clinical trials.
...
1.  Explore the `gapminder` data frame and:
...
3.  Write a data processing snippet to include only the data points collected after 1995 in Asian countries as a CSV file.\
