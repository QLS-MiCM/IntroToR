...
![](../images/ArithmeticOperators.png){fig-align="center"}
...
1.  **Standard Style (Recommended):** Use a space before and after the symbol: `1 + 1`. This is the professional standard (often called the [Tidyverse Style Guide](https://style.tidyverse.org/)). It makes your code much easier to read.
